...
class SalonCLI:
    ...
    def show_services(self) -> None:
        ...
        print("ID | Name | Duration | Price | Mode")
    ...
    def add_service(self) -> None:
        ...
        duration = self.read_int("Duration in minutes: ")
        price = float(input("Price: "))
        execution_mode = self.read_service_mode()
        service = self.manager.create_service(name, duration, price, execution_mode)
    ...
    def complete_booking(self) -> None:
        ...
        if selected.service.requires_notes:
    ...
    def read_service_mode(self) -> str:
        while True:
            print("Service type:")
            print(f"1 {Service.TOOL_BASED}")
            print(f"2 {Service.CONSULTATION}")
            value = input("Choose service type: ").strip()
            if value == "1":
                return Service.TOOL_BASED
            if value == "2":
